...
class TimePlot(object):
    ...
    #def PlotScheduleData_QtySumByWeek_ForDateRange(self, arg_date_start, arg_date_end):
    #    pass
    #def PlotScheduleData_QtySumByWeek(self, arg_day):
    #    pass

    #def PlotScheduleData_QtyByDay_ForDateRange(self, arg_date_start, arg_date_end):
    #    pass
    #def PlotScheduleData_QtyByDay(self, arg_day):
    #    pass

    #def PlotLogData_SplitSumByMonth_ForDateRange(self, arg_month, arg_date_start, arg_date_end):
    #    pass
    #def PlotLogData_SplitSumByMonth(self, arg_month):
    #    pass

    #def PlotLogData_SplitSumsByWeek_ForDateRange(self, arg_date_start, arg_date_end):
    #    pass
    #def PlotLogData_SplitSumsByWeek(self, arg_week_start):
    #    pass

    #def PlotLogData_SplitsByDay_ForDateRange(self, arg_date_start, arg_date_end):
    #    pass
    #def PlotLogData_SplitsByDay(self, arg_day):
    #    pass
    ...
    #    located_filepaths = TimePlotUtils._GetAvailableFiles_FromMonthlyRange(arg_data_dir, arg_file_prefix, arg_file_postfix)
    ...
    #   {{{
        ...
        ##located_filepaths = self._GetAvailableFiles_FromMonthlyRange(arg_data_dir, arg_file_prefix, arg_file_postfix)
        ##   For month of arg_date_month, get days_list
        #y = arg_date_month.year
        #m = arg_date_month.month
        ...
        located_filepaths = TimePlotUtils._GetFiles_FromMonthlyRange(arg_data_dir, arg_file_prefix, arg_file_postfix, arg_days_list[0], arg_days_list[-1], True)
        #located_filepaths = self._GetAvailableFiles_FromMonthlyRange(arg_data_dir, arg_file_prefix, arg_file_postfix)
...
#        ax.set_ylim(0, 15)
    ...
    #        loop_filestr = self._GPGDecryptFileToString(loop_filepath)
    ...
    #                    loop_dt_str = self._Fix_DatetimeStr(loop_dt_str)
